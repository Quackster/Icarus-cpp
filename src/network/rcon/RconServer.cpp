...
@return none
*/
RconServer::RconServer(boost::asio::io_service& io_service, std::string host, short port) :
	acceptor(io_service, tcp::endpoint(boost::asio::ip::address::from_string(host), port)),//tcp::endpoint(tcp::v4(), port)), 
	socket(io_service),
	connection_id(0) {
